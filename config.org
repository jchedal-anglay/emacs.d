...
#+BEGIN_SRC emacs-lisp
  ...
  (pretty-hydra-define hydra-help (:exit t :color amaranth :quit-key "q")
    ("Bindings"
  ...
  (pretty-hydra-define hydra-window (:exit nil :color amaranth :quit-key "q")
    (" Windows"
