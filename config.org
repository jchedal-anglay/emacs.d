...
(defconst ign:python "python3")
(defconst ign:ipython "ipython3")
#+END_SRC
...
(use-package doom-modeline
  ...
  :custom
  (doom-modeline-python-executable ign:python)
...
(use-package dap-mode
  ...
  :hook lsp-mode
  :custom
  (dap-python-executable ign:python)
  :config
  (require 'dap-python)
  (require 'dap-lldb))
#+END_SRC
...
(use-package flycheck
  ...
  :custom
  (flycheck-python-pylint-executable ign:python)
  (flycheck-python-pycompile-executable ign:python)
  (flycheck-python-flake8-executable ign:python)
  (flycheck-python-mypy-executable ign:python)
...
(use-package python
  ...
  :custom
  (python-indent 4)
  (python-shell-interpreter ign:ipython)
...
(use-package phi-search
  ...
  ("C-s" . phi-search)
  :config
  (advice-add 'phi-search :after #'phi-search-recenter)
  (advice-add 'phi-search-backward :after #'phi-search-recenter)
  (advice-add 'phi-search-again-or-next :after #'phi-search-recenter)
  (advice-add 'phi-search-again-or-previous :after #'phi-search-recenter)
  (advice-add 'phi-search-complete :after #'phi-search-recenter)
