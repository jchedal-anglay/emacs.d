...
#+BEGIN_SRC emacs-lisp
  ...
  (pretty-hydra-define hydra-window (:exit t :color amaranth :title " Windows")
    ("Split"
     ...
     (("h" windmove-left "left" :exit nil)
      ("c" windmove-up "up" :exit nil)
      ("t" windmove-down "down" :exit nil)
      ("n" windmove-right "right" :exit nil))))
