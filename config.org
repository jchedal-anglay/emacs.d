...
(use-package phi-search
  :bind
  ("C-r" . phi-search)
  ([remap phi-search-maybe-next-line] . phi-search-again-or-next)
  ([remap phi-search-maybe-previous-line] . phi-search-again-or-previous)
  :custom-face
  (phi-search-selection-face ((nil (:background "orange"))))
  :config
