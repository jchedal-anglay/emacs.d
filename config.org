...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Required for it to work *exactly* like C-g as defined in delsel.el
  (key-chord-define-global "eu" #'keyboard-quit)
  (key-chord-define minibuffer-local-map "eu" #'minibuffer-keyboard-quit)
  (key-chord-define minibuffer-local-ns-map "eu" #'minibuffer-keyboard-quit)
  (key-chord-define minibuffer-local-completion-map "eu" #'minibuffer-keyboard-quit)
  (key-chord-define minibuffer-local-must-match-map "eu" #'minibuffer-keyboard-quit)
  (key-chord-define minibuffer-local-isearch-map "eu" #'minibuffer-keyboard-quit)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (pretty-hydra-define hydra-config (:exit t :color amaranth :quit-key "q")
    (" Configuration"
     (("e" ign/edit-config "config file")
      ("g" ign/refresh-buffer "refresh buffer")
      ("r" ign/reload "reload")
      ("DEL" save-buffers-kill-terminal "quit emacs"))))

  (pretty-hydra-define hydra-projectile (:exit t :color amaranth :quit-key "q")
    (" Projectile"
  ...
  (pretty-hydra-define hydra-avy (:exit t :color amaranth :quit-key "q")
    ("Goto"
  ...
  (pretty-hydra-define hydra-leader (:exit t :color amaranth :quit-key "q")
    (" Leader"
     (("RET" hydra-config/body (propertize "+config" 'face 'bold))
      ("SPC" ign/ide-resolve (propertize "+ide" 'face 'bold))
      (";" hydra-avy/body (propertize "+jump" 'face 'bold))
