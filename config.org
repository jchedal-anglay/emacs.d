...
Elpy is used for refactoring function
Requires:
- python3
...
#+BEGIN_SRC emacs-lisp
(key-chord-define-global "eu" (lambda () (interactive) (insert "é")))
(key-chord-define-global "EU" (lambda () (interactive) (insert "É")))

(key-chord-define-global "ah" (lambda () (interactive) (insert "à")))
(key-chord-define-global "eh" (lambda () (interactive) (insert "è")))
(key-chord-define-global "uh" (lambda () (interactive) (insert "ù")))
(key-chord-define-global "AH" (lambda () (interactive) (insert "À")))
(key-chord-define-global "EH" (lambda () (interactive) (insert "È")))
(key-chord-define-global "UH" (lambda () (interactive) (insert "Ù")))

(key-chord-define-global "at" (lambda () (interactive) (insert "â")))
(key-chord-define-global "et" (lambda () (interactive) (insert "ê")))
(key-chord-define-global "it" (lambda () (interactive) (insert "î")))
(key-chord-define-global "ot" (lambda () (interactive) (insert "ô")))
(key-chord-define-global "ut" (lambda () (interactive) (insert "û")))
(key-chord-define-global "AT" (lambda () (interactive) (insert "Â")))
(key-chord-define-global "ET" (lambda () (interactive) (insert "Ê")))
(key-chord-define-global "IT" (lambda () (interactive) (insert "Î")))
(key-chord-define-global "OT" (lambda () (interactive) (insert "Ô")))
