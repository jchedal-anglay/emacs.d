...
#+BEGIN_SRC emacs-lisp
  (use-package flycheck
    ...
    :custom
    (flycheck-checkers '(python-flake8 python-mypy python-pycompile c/c++-clang c/c++-cppcheck))
    :config
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package elpy
    ...
    :bind
    (:map python-mode-map
          ([remap elpy-shell-send-region-or-buffer] . elpy-shell-send-statement-and-go)
          ([remap lsp-rename] . elpy-multiedit-python-symbol-at-point)
          ([remap lsp-format-buffer] . elpy-format-code))
    :custom
    (elpy-modules '(elpy-module-sane-defaults elpy-module-pyvenv))
